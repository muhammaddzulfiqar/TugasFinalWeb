  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-2">PROJECT FINAL</div>
      </a>
 ...
 <?php
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 <img src="img/userr.png<?php echo $data['']?>" class="img-circle" width="80" alt="User"/></a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2021 . Muh. Dzulfiqar D. M | D12118510</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
