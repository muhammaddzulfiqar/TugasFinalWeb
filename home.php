...
<br>
       ...
       <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div>
            <img src="img/hero-img.png" width="500/">
          </div>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                    <img src="img/userr.png" width="50"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                    <img src="img/notebook.png" width="50"/>
                    </div>
                  </div>
                </div>
              </div>
       ...
       <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     <a  href="?page=barangmasuk"> <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><h4>Barang Masuk</h4></div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                    ...
                    <div class="col-auto">
                      <img src="img/mobile.png" width="60"/>
                    </div>
                  </div>
                </div>
              </div>
